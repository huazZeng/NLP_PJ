...
json_file_path = 'data\MATH_train_fineture.jsonl'
with open(json_file_path, 'r', encoding="utf-8") as json_file:
    datas = [json.loads(line) for line in json_file]
...
for data in datas:
    ...
    if(answer_clean):
        ...
        count+=1
with open('data\MATH_train_fineture_format.jsonl', 'w', encoding="utf-8") as output_file:
    for item in datas:
