...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{GSM8K-LORA.png} % 插入图片
  \caption{基于GSM8K数据集的SFT与LoRA微调对比} % 图注
  \label{fig:my_label0} % 标签
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{MATH-LORA.png} % 插入图片
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{scaling_graph.png} % 插入图片
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{compare_graph.png} % 插入图片
  \caption{3B模型与0.5B模型的效果曲线图} % 图注
